  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "h-8 w-8 bg-transparent p-0 opacity-70 hover:opacity-100 rounded-full border border-input hover:bg-accent hover:text-accent-foreground"
        ),
        ...
        day: cn(
          "h-10 w-10 p-0 font-normal aria-selected:opacity-100 rounded-xl hover:bg-accent hover:text-accent-foreground"
        ),
        ...
        day_today: "bg-accent text-accent-foreground rounded-xl shadow-md",
        day_outside:
